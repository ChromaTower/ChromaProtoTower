...
public class ColorManager : MonoBehaviour {
	...
	public void introduceColor()
	{
		...
		{
			ent.GetComponent<Renderer>().material.color = colorFromHSV(Mathf.Abs (hue), 1f, 0.8f);
		}
		...
		GameManager.instance.getTower ().generatePickup(4,colorFromHSV(Mathf.Abs (hue), 1f, 0.5f) );
	}
